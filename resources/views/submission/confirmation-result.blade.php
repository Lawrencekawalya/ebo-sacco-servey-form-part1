...
<body class="{{ session('status') ? session('status') : 'default' }}">
    ...
    <div class="container">
        ...
        @if ($status === 'success')
            ...
            <h1>Submission Confirmed Successfully!</h1>
        ...
        @elseif ($status === 'already_confirmed')
            ...
            <h1>Submission Already Confirmed</h1>
            <p class="subtitle">Your survey has been previously confirmed</p>

            <div class="message">
                <p>This survey submission was already confirmed on {{ date('F j, Y', strtotime('-1 day')) }} at
                    {{ date('g:i A', strtotime('-3 hours')) }}. No further action is required from you.</p>
                <p>If you believe this is an error or if you have any questions, please contact the HR department.</p>
            </div>
            ...
            <div class="details">
                <div class="detail-item">
                    ...
                    <div class="detail-text">
                        ...
                        <div class="detail-value">Already Processed</div>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-icon">
                    ...
                    <div class="detail-text">
                        <div class="detail-label">Original Submission</div>
                        <div class="detail-value">{{ date('F j, Y g:i A', strtotime('-1 day')) }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="actions">
                ...
                <a href="mailto:hr@ebo.org" class="btn btn-outline">
        ...
        @elseif ($status === 'expired')
            ...
            <p class="subtitle">This confirmation link is no longer valid</p>

            <div class="message">
                <p>For security reasons, confirmation links expire after 2 hours. This link was generated more than 2
                    hours ago and can no longer be used to confirm your submission.</p>
                <p><strong>Solution:</strong> You will need to submit the survey again to receive a new confirmation
                    email.</p>
            </div>
            ...
            <div class="details">
                <div class="detail-item">
                    ...
                    <div class="detail-text">
                        ...
                        <div class="detail-value">Link expired (2-hour security limit)</div>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-icon">
                    ...
                    <div class="detail-text">
                        ...
                        <div class="detail-value">Resubmit the survey</div>
                    </div>
                </div>
            </div>
            ...
            <div class="actions">
                ...
                <a href="mailto:support@ebo.org" class="btn btn-outline">
        ...
        @else
            ...
            <p class="subtitle">This link could not be processed</p>

            <div class="message">
                <p>The confirmation link you used is invalid, has already been used, or contains an error. This could
                    happen if:</p>
                <ul style="padding-left: 20px; margin: 15px 0;">
                    <li>The link was copied incorrectly</li>
                    <li>The submission has already been confirmed</li>
                    <li>The link was altered or tampered with</li>
                </ul>
            </div>
            ...
            <div class="details">
                <div class="detail-item">
                    ...
                    <div class="detail-text">
                        <div class="detail-label">Status</div>
                        <div class="detail-value">Invalid or Used Link</div>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-icon">
                    ...
                    <div class="detail-text">
                        ...
                        <div class="detail-value">One-time use only</div>
                    </div>
                </div>
            </div>
            ...
            <div class="actions">
                <a href="/" class="btn btn-primary">
                    <i class="fas fa-pencil-alt"></i> Start New Survey
                </a>
